...
const logger = {
    ...
    success: function (message, label) {
        // @ts-ignore
        this.log(message, console_1.console.chalk.bgGreen.black(label ? ' ' + label + ' ' : ' SUCCESS '));
    },
    error: function (message, label) {
        // @ts-ignore
        this.log(message, console_1.console.chalk.bgRed.black(label ? ' ' + label + ' ' : '  ERROR  '));
    },
    warn: function (message, label) {
        // @ts-ignore
        this.log(message, console_1.console.chalk.bgYellow.black(label ? ' ' + label + ' ' : ' WARNING '));
    },
};
